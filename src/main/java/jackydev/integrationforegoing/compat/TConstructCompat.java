package jackydev.integrationforegoing.compat;
...
public class TConstructCompat {
    ...
    public static void init() {
        ...
        plastic.setRepresentativeItem(ModUtils.getItemByObject("industrialforegoing", "plastic"));

        final Material pinkSlime = materials.get("pink_slime");
        pinkSlime.addItem(ModUtils.getItemByObject("industrialforegoing", "pink_slime"), 1, Material.VALUE_Fragment);
        pinkSlime.setRepresentativeItem(ModUtils.getItemByObject("industrialforegoing", "pink_slime"));
    }
