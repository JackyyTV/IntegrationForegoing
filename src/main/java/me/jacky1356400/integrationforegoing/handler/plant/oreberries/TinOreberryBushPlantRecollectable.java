...
public class TinOreberryBushPlantRecollectable implements IPlantRecollectable {

    @Override
    public boolean canBeHarvested(World world, BlockPos pos, IBlockState blockState) {
        return blockState.getBlock() == ModUtils.getBlockByObject("oreberries", "tin_oreberry_bush")
    ...
    public List<ItemStack> doHarvestOperation(World world, BlockPos pos, IBlockState blockState) {
        ...
        stacks.add(0, ModUtils.getItemStackByObject("oreberries", "tin_oreberry", world.rand.nextInt(3) + 1, 0));
