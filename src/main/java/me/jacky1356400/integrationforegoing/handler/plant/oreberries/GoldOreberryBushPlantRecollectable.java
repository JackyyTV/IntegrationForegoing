...
public class GoldOreberryBushPlantRecollectable implements IPlantRecollectable {

    @Override
    public boolean canBeHarvested(World world, BlockPos pos, IBlockState blockState) {
        return blockState.getBlock() == ModUtils.getBlockByObject("oreberries", "gold_oreberry_bush")
    ...
    public List<ItemStack> doHarvestOperation(World world, BlockPos pos, IBlockState blockState) {
        ...
        stacks.add(0, ModUtils.getItemStackByObject("oreberries", "gold_oreberry", world.rand.nextInt(3) + 1, 0));
