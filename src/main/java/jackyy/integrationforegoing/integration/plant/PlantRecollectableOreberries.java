    ...
    public void register(RegistryEvent.Register<PlantRecollectable> event) {
        ...
        registry.register(new PlantRecollectable(ModNames.OREBERRIES) {
            ...
            public boolean canBeHarvested(World world, BlockPos pos, IBlockState blockState) {
                ...
                return registryName.getNamespace().equals(ModNames.OREBERRIES)
                        && registryName.getPath().endsWith("_oreberry_bush");
            }
            ...
            public List<ItemStack> doHarvestOperation(World world, BlockPos pos, IBlockState blockState) {
                ...
                stacks.add(0, ObjectHelper.getItemStackByName(ModNames.OREBERRIES, name.substring(0, name.length() - 5), world.rand.nextInt(3) + 1, 0));
